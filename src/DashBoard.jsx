                  ...
                  <div className={style.div4item1}>
                    <div className={style.total11}>
                      ...
                      <div className={style.num}>
                        ...
                        <li className={style.imgpro}><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
                    ...
                    <div className={style.total21}>
                      ...
                      <div className={style.num}>
                        ...
                        <li className={style.imgpro}><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-currency-dollar" viewBox="0 0 16 16">
                    ...
                    <div className={style.total31}>
                      ...
                      <div className={style.num}>
                        ...
                        <li className={style.imgpro}><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-arrow-up-right" viewBox="0 0 16 16">
                    ...
                    <div className={style.total41}>
                      ...
                      <div className={style.num}>
                        ...
                        <li className={style.imgpro}><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-file-earmark-ruled" viewBox="0 0 16 16">
                ...
                <div className={style.rajveerdiv2}>
                  ...
                  <div className={style.upcoming}>
                    ...
                    <div className={style.newstudent}>
                      ...
                      <li className={style.en11}>medium</li>
                    </div>
                    ...
                    <div className={style.newstudent} >
                      ...
                      <li className={style.en11}>low</li>
                    </div>
                ...
                <div className={style.userRolediv}>
                  ...
                  <div className={style.userRole}>
                    <div className={style.user1}>
                      <div className={style.add}> <li className={style.admin}>Administrator</li><li className={style.u31}>3 users</li> </div>
                    ...
                    <div className={style.user2}>
                      <div className={style.add}> <li className={style.admin}>Faculty</li><li className={style.u32}>89 users</li> </div>
                    ...
                    <div className={style.user4}>
                      <div className={style.add}> <li className={style.admin}>Student</li><li className={style.u33}>99 users</li> </div>
